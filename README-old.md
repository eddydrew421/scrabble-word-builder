...
# tests/domain/challengeExamples.test.ts

This is the quick test file to run showing the pass/fail scenarios from the brief.


# Quick Start

This is an app that you will run locally via CLI.
...
`
curl -s -G 'http://127.0.0.1:3001/api/v1/solve' \
